    ...
    <>
      ...
      >
        ...
        <div className="flex-1 space-y-6 overflow-y-auto overscroll-contain p-5">
                    ...
                    return (
                      ...
                      >
                        <span className="flex items-center gap-1.5">
                          {active && <Check className="size-4 shrink-0 text-[hsl(var(--primary))]" aria-hidden />}
                          {option.name}
                        </span>
          ...
          <div>
            <label htmlFor="line-notes" className="mb-2 block font-display text-xl font-bold">
              Notes <span className="text-sm font-normal text-[hsl(var(--muted-foreground))]">(optional)</span>
            </label>
            <textarea
              id="line-notes"
              value={notes}
